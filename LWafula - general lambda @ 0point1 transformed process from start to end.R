...
for(j in 1:length(lambda)){
  ...
  fn_out<- paste0('p1601xxPPS_means_preprocessedfeat_act_',lambda[j],'.RData')
...
# 
# #save
lambdafeatactv_alphacorrected0<-'E:/uhasselt/22yrsem/MThesis/data/glog transformed datasets by lambda/lambdafeatactv_alphacorrected0p1to15.csv'
