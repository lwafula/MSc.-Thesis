...
# #plots
# lambdavsoptfeature_alpha<-'lambdavsoptfeature_alpha.pdf'
...
#      ylab='Optimal features',ylim=c(10,30))
# dev.off()
# # 
# lambdavsactcall_alpha<-'lambdavsactcall_alpha.pdf'
# lambdavsactcall_alpha<-file.path(dataview,lambdavsactcall_alpha)
# pdf(lambdavsactcall_alpha)
# plot(lambdafeatactv_alphacorrected[,1],lambdafeatactv_alphacorrected[,3],pch=19,type='l',xlab=expression(lambda),ylab='active calling %',ylim=c(54,57))
# dev.off()
# 
# #save
lambdafeatactv_alphacorrected0<-'glog transformed datasets by lambda/lambdafeatactv_alphacorrected.csv'
